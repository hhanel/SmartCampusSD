...
// Remover -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	public boolean excluirColecaoTipoSensor() {
		int resposta = JOptionPane.showConfirmDialog(null, "Deseja realmente remover a colecao \"Tipo Sensor\" e seu conteudo?", "MongoDB - AVISO - REMO플O DE COLE플O", JOptionPane.YES_NO_OPTION);
	...
	public boolean excluirColecaoSensor() {
		int resposta = JOptionPane.showConfirmDialog(null, "Deseja realmente remover a colecao \"Sensor\" e seu conteudo?", "MongoDB - AVISO - REMO플O DE COLE플O", JOptionPane.YES_NO_OPTION);
	...
	public boolean excluirColecaoDados() {
		int resposta = JOptionPane.showConfirmDialog(null, "Deseja realmente remover a colecao \"Dados\" e seu conteudo?", "MongoDB - AVISO - REMO플O DE COLE플O", JOptionPane.YES_NO_OPTION);
	...
	public boolean excluirBaseDados() {
		...
		int resposta = JOptionPane.showConfirmDialog(null, "Deseja realmente remover toda a base de dados e seu conteudo?", "MongoDB - AVISO DE REMO플O DE BASE DE DADOS", JOptionPane.YES_NO_OPTION);
